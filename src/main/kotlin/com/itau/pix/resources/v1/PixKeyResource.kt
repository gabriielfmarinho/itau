...
class PixKeyResource(
    ...
    @PostMapping(produces = [MEDIA_TYPE_V1])
    ...
    @GetMapping("/{id}", produces = [MEDIA_TYPE_V1])
    ...
    @GetMapping("/paged", produces = [MEDIA_TYPE_V1])
    ...
    @DeleteMapping("/{UUID}", produces = [MEDIA_TYPE_V1])
